...
const sdkDependencyDecisionOf = (text) =>
  checkedDecision(sectionText(text, "SDK Dependency Approval"), [
...
const realDeviceQrDecisionOf = (text) =>
  checkedDecision(sectionText(text, "Real Device QR Approval"), [
    "Approved for Toss review request",
    "Needs QR follow-up",
...
const printHelp = () => {
  console.log("Usage: node scripts/build-commander-review-index.mjs [paths...] [--dir <dir>] [--output <path>] [--json] [--strict] [--github-summary] [--help]");
  console.log("");
  console.log("Options:");
